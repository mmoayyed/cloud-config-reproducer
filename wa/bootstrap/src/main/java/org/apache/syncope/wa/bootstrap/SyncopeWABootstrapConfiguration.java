...
public class SyncopeWABootstrapConfiguration {
    ...
    @Bean
    public PropertySourceLocator syncopeConfigPropertySourceLocator(final WARestClient waRestClient) {
        return new SyncopeWAPropertySourceLocator(waRestClient);
    }

    @Bean
    public WARestClient waRestClient() {
        return new WARestClient("anonymous", "anonymous", true);
    }
...
////        @Value("${wa.anonymousUser:anonymous}")
////        private String anonymousUser;
//////
////        @Value("${wa.anonymousKey:anonymousKey}")
